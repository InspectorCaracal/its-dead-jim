...
MSSPTable = {
    # Required fields
    "NAME": "NEXUS",  # usually the same as SERVERNAME
    # Generic
    "CRAWL DELAY": "23",  # limit how often crawler may update the listing. -1 for no limit
    "HOSTNAME": "",  # telnet hostname
    "PORT": ["4003"],  # telnet port - most important port should be *last* in list!
    "CODEBASE": "Evennia",
    ...
    "LOCATION": "USA",  # English short name of the country where the server is located, using ISO 3166.
    "MINIMUM AGE": "0",  # set to 0 if not applicable
    "WEBSITE": "",  # http:// address to your game website
    # Categorisation
    "FAMILY": "Evennia",  # evennia goes under 'Custom'
    "GENRE": "Fantasy, Science Fiction",  # Adult, Fantasy, Historical, Horror, Modern, None, or Science Fiction
    ...
    "MOBILES": "-1",
    "OBJECTS": "-1",
    "ROOMS": "-1",  # use 0 if room-less
    "CLASSES": "-1",  # use 0 if class-less
    "LEVELS": "-1",  # use 0 if level-less
    "RACES": "-1",  # use 0 if race-less
