...
"""
    ...
    def test_reformat(self):
        """
        issues currently with the wrap on reformatted headings 1 and 2
        """
        table = evtable.EvTable(
            "|yHeading1|n",
            "|gHeading2|n",
